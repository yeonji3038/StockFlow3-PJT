package com.stockflow.store.domain.allocation.service;

import com.stockflow.store.domain.allocation.dto.AllocationRequestDto;
import com.stockflow.store.domain.allocation.dto.AllocationResponseDto;
import com.stockflow.store.domain.allocation.entity.Allocation;
import com.stockflow.store.domain.allocation.entity.AllocationItem;
import com.stockflow.store.domain.allocation.entity.AllocationStatus;
import com.stockflow.store.domain.allocation.repository.AllocationItemRepository;
import com.stockflow.store.domain.allocation.repository.AllocationRepository;
...
import com.stockflow.store.domain.stockhistory.service.StockHistoryService;
...
import com.stockflow.store.domain.store.repository.StoreStockRepository;
